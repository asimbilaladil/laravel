    ...
    public function updateApplication($id, $input)
    {
        DB::table('accounts') ->where('id', $id) ->update(
            array('first_name' => $input['first_name'],
                  ...
                  'dob' => $input['dob'],
                  'is_dependant' => $input['is_dependant'],
                  'account_number' => $input['account_number']));

        DB::table('factors') ->where('id', $input['factor_id']) ->update(
            array('citizenship_type_id' => $input['citizenship_type_id'],
                  'is_ibhap' => $input['is_ibhap'],
                  'is_pregnant' => $input['is_pregnant'],
                  'has_primary_care' => $input['has_primary_care'],
                  'is_victim' => $input['is_victim'],
